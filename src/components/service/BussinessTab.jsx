...
import IMG from "../../assets/service/bussiness.png";
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16 py-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-start">
        ...
        <button className="bg-brand-primary text-white mt-8 flex items-center justify-between px-6 py-3.5 gap-4 rounded-xl text-sm font-semibold hover:opacity-95 transition cursor-pointer">
